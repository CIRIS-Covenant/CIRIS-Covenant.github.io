...
These parables—one drawn from painful history, others from plausible futures—demonstrate how CIRIS principles, mechanisms, and governance either prevent harm or turn failure into learning. Section IV now details your standing obligations within the wider ecosystem.
